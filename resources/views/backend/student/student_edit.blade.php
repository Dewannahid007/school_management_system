                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col">
                                    <form action="{{route('student.reg.update',$editData->student_id)}}" enctype="multipart/form-data" method="post">
                                        @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                                <div class="controls">
                                         <img id="showImage" src="{{(!empty($editData['student']['image']))?url('upload/student_images/'.$editData['student']['image']):url('upload/no_image.jpg')}}" style="height:100px; width:100px; border:1px solid black">
