					  ...
					  <table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td> 
                                    <a href="{{route('assign.subject.edit',$assign->class_id)}}" class="btn btn-primary">Edit</a> 
                                    <a href="{{route('assign.subject.details',$assign->class_id)}}" class="btn btn-info">Details</a>
                                </td>
							</tr>
                            @endforeach
						</tbody>
